##################### variable (modificare solo questa parte)
# top entity
...
set init_top_cell ${top_entity}
set init_verilog ../netlist/${top_entity}.v
...
timeDesign -postRoute -pathReports -drvReports -slackReports -numPaths 50 -prefix ${top_entity}_postRoute -outDir timingReports
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -hold -pathReports -slackReports -numPaths 50 -prefix ${top_entity}_postRoute -outDir timingReports
...
reportGateCount -level 5 -limit 100 -outfile ${top_entity}.gateCount
saveNetlist ${top_entity}.v
